    ...
    def exit_(self):
        if self.is_file_open:
            ...
            if file_content == text_area.get(1.0,END):
                ...
                response = messagebox.askquestion("uyari","dosyanizda birtakim degisiklikler yapıldı.Kaydetmek istiyor musunuz?")
                print(response)
                if response == "yes":
                    self.save()
                    pcr.destroy()
    ...
    def new_file(self):
        ...
        if self.is_file_open:
            ...
            if file_content == text_area.get(1.0,END):
                ...
                response = messagebox.askquestion("uyari","Acılmıs bir dosyaniz var ve dosyanizda birtakim degisiklikler yapıldı.Kaydetmek istiyor musunuz?")
                print(response)
                if response == "yes":
                    self.save()
                    text_area.delete(1.0,END)
